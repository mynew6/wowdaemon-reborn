...
namespace WoWDaemon.Realm
{
	...
	public class RealmListClient : ClientBase
	{
		...
		public RealmListClient(Socket sock) : base(sock, 4)
		{
		...
		public override int PacketSize
		{
			get
			{
				switch((REALMLISTOPCODE)m_header[0])
				{
					case REALMLISTOPCODE.CHALLENGE:
					case REALMLISTOPCODE.RECODE_CHALLENGE:
						return BitConverter.ToUInt16(m_header, 2)+4;
					...
					case REALMLISTOPCODE.REALMLIST_REQUEST:
						return 0x05;
					default:
						throw(new RealmWarning("Unhandled realm opcode " + m_header[0]));
				}								
			}
		}
